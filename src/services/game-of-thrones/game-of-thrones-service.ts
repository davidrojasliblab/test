...
import { GetTranslateDothrakiParams, GetTranslateValyrianParams } from './request-params';

export class GameOfThronesService extends BaseService {
  /**
